...
using Zian.NpoiCore.Mapper.Attributes;

namespace Zian.NpoiCore.Mapper.Extensions
{
    /// <summary>
    ...
    public static class MapExtensions
    {
        ...
        public static Zian.NpoiCore.Mapper.Mapper Map(this Zian.NpoiCore.Mapper.Mapper mapper, string columnName, PropertyInfo propertyInfo,
        ...
        /// <param name="tryPut">The function try to export source object to the cell.</param>
        /// <returns>The mapper object.</returns>
        public static Zian.NpoiCore.Mapper.Mapper Map<T>(this Zian.NpoiCore.Mapper.Mapper mapper, string columnName, string propertyName,
            Func<IColumnInfo, object, bool> tryTake = null,
            Func<IColumnInfo, object, bool> tryPut = null)
        {
        ...
        /// <param name="tryPut">The function try to export source object to the cell.</param>
        /// <returns>The mapper object.</returns>
        public static Zian.NpoiCore.Mapper.Mapper Map<T>(this Zian.NpoiCore.Mapper.Mapper mapper, string columnName, Expression<Func<T, object>> propertySelector,
            Func<IColumnInfo, object, bool> tryTake = null,
            Func<IColumnInfo, object, bool> tryPut = null)
        {
            if (mapper == null) throw new ArgumentNullException(nameof(mapper));
        ...
        /// <param name="tryPut">The function try to export source object to the cell.</param>
        /// <returns>The mapper object.</returns>
        public static Zian.NpoiCore.Mapper.Mapper Map<T>(this Zian.NpoiCore.Mapper.Mapper mapper, ushort columnIndex, string propertyName,
            Func<IColumnInfo, object, bool> tryTake = null,
            Func<IColumnInfo, object, bool> tryPut = null)
        {
            if (mapper == null) throw new ArgumentNullException(nameof(mapper));
